...
Make sure environment is selected before running.
Don't hardcode token or user ID.
Use console and Test Results panel to debug.
Save requests before running the Collection.
Order matters in the Runner — login must run before create user.
